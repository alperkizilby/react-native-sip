...
/**
 * Bağlantı süresi "MM:SS" formatında.
 *
 * @public
 * @returns {string}
 */
...
/**
 * Aranan adı. URI'de belirtilmediyse null olabilir.
 * @returns {String}
 */
getRemoteName() {
...
/**
 * Davet oturumu durumu.
 *
 * PJSIP_INV_STATE_NULL           INVITE gönderilmeden veya alınmadan önce
 * PJSIP_INV_STATE_CALLING        INVITE gönderildikten sonra
 * PJSIP_INV_STATE_INCOMING       INVITE alındıktan sonra.
 * PJSIP_INV_STATE_EARLY          Yanıtta To etiketi aldıktan sonra.
 * PJSIP_INV_STATE_CONNECTING     2xx gönderildikten/alındıktan sonra.
 * PJSIP_INV_STATE_CONFIRMED      ACK gönderildikten/alındıktan sonra.
 * PJSIP_INV_STATE_DISCONNECTED   Oturum sonlandırıldı.
 *
 * @returns {String}
 */
getState() {
...
/**
 * Uzaktan SDP teklif eden bayrak
 * @returns {boolean}
 */
getRemoteOfferer() {
  // TODO Boolean değer doğrulanmalı
  return this._remoteOfferer;
}

/**
 * Uzak tarafın teklif ettiği ses akışlarının sayısı.
 * @returns {int}
 */
getRemoteAudioCount() {
...
/**
 * Uzak tarafın teklif ettiği video akışlarının sayısı.
 * @returns {int}
 */
getRemoteVideoCount() {
...
/**
 * Bu çağrı için eşzamanlı etkin ses akışlarının sayısı. Sıfır ise bu çağrıda ses devre dışı.
 * @returns {int}
 */
getAudioCount() {
...
/**
 * Bu çağrı için eşzamanlı etkin video akışlarının sayısı. Sıfır ise bu çağrıda video devre dışı.
 * @returns {*}
 */
getVideoCount() {
...
/**
 * Son duyulan durum kodu, neden kodu olarak kullanılabilir.
 * Olası değerler:
 * - PJSIP_SC_TRYING / 100
...
/**
 * Son durumu tanımlayan neden ifadesi.
 *
 * @returns {string}
 */
getLastReason() {
...
/**
 * Saniyeleri "MM:SS" formatına dönüştürür.
 *
 * @public
 * @returns {string}
 */
